...
try:
    from backend.src.processamento_bulas.paths import BULAS_JSON_DIR, BULAS_PDF_DIR
except ModuleNotFoundError:
    from src.processamento_bulas.paths import BULAS_JSON_DIR, BULAS_PDF_DIR
...
PASTA_PDF = BULAS_PDF_DIR
PASTA_JSON = BULAS_JSON_DIR
RETRIES = 3
